...
class Bitmap {
  constructor(filePath, buffer) {
    ...
    if (this.info.paletteColorCount) {
      ...
      this.info.colorPaletteOffset =
        14 + this.info.headerSize + 4 * (this.info.compressionMethod ? 1 : 0);
   ...
   */
  getPixelOffset(x, y) {
    // I like top-left-corner location better for images. Bitmaps with positive
    // height index at the bottom left corner. Flip it in that case.
